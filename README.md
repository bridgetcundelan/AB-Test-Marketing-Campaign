...
* Funnel Performance: For both campaigns, there is a high "view content" conversion rate and a drop off when we get to the "add to cart" conversion rate stage. This could be for a couple of reasons: interest vs intent- consumers may be researching but not ready to buy. Similarly, they may be comparing various products before purchasing. The consumers could be experiencing price sensitivity. Additionally, it might be worthwhile taking a look at the user experience- is the website difficult to navigate, is the checkout process complicated, is the copy or call to action compelling? Are the products in stock?
* Conversely, there is a high "search" conversion rate once consumers land on the site. This could speak to effective marketing and retargeting, a personalized experience on the site which makes consumers want to explore more, or a prominent search bar. It could also mean the site is complex and consumers need to use the search function to find products. 
...
* Similarly, I would recommend the team take a look at the stage between "view content" and "add to cart" to uncover why there is drop off at this stage. I would also recommend they take a look at the stage between clicking onto the website and making searches.
